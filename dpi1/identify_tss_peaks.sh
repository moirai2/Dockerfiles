...
case ${decomposition} in
  ...
  "y"|"Y")
    ...
    do 
      qsub.pl -cwd -v RAKE_TARGET=$X -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v "${qsub_v}" -N xqsub$$_01_bw ./scripts/qsub.sh &
    done

    ### 02 - 05 ###
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_02_pool -v RAKE_TARGET=pool_ctss -hold_jid xqsub$$_01_bw   ./scripts/qsub.sh
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_03_tag_clustering -v RAKE_TARGET=tc -hold_jid xqsub$$_02_pool ./scripts/qsub.sh
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_04_tc_short -v RAKE_TARGET=tc_short -hold_jid xqsub$$_03_tag_clustering ./scripts/qsub.sh
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_05_tc_long -sync y -v RAKE_TARGET=tc_long -hold_jid xqsub$$_03_tag_clustering ./scripts/qsub.sh
    ...
    ### 07 - 09 ###
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_07_comp_ctss -v RAKE_TARGET=comp_ctss -hold_jid xqsub$$_06_dpi_each ./scripts/qsub.sh
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_08_final -v RAKE_TARGET=final -hold_jid xqsub$$_06_dpi_each,xqsub$$_04_tc_short ./scripts/qsub.sh
    qsub.pl -cwd -o ${dpi_out_path}/log/ -e ${dpi_out_path}/log/ -v ${qsub_v} -N xqsub$$_09_threshold -sync y -v RAKE_TARGET=threshold -hold_jid xqsub$$_08_final ./scripts/qsub.sh
    )
  ;;
  *)
    usage;;
